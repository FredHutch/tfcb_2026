...
again and make sure that the output ends with `tfcb_2026/lectures/lecture04`.
...
On my computer the `pwd` command outputs
    ...
    /home/melody/tfcb_2026/lectures/lecture04/02-directories
...
If you are using the Docker container via VS Code, I *believe* your absolute path should look like this:
    ...
    /workspaces/tfcb_2026/lectures/lecture04/02-directories

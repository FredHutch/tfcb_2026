...
Download the course files with the following link: [github.com/FredHutch/tfcb_2026/archive/refs/heads/main.zip](https://github.com/FredHutch/tfcb_2026/archive/refs/heads/main.zip). Copy the contents of `homeworks/homework01/messy-project-directory/` to a new directory on your computer named `tfcb-homework01`.
